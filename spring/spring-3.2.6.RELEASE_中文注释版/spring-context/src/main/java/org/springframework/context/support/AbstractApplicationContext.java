...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	static {
		...
		//Ϊ�˱���Ӧ�ó�����Weblogic8.1�ر�ʱ����������쳣�������⣬����IOC�����ر��¼�(ContextClosedEvent)��
	 ...
	 */
	//FileSystemXmlApplicationContext���ø��๹�췽�����õľ��Ǹ÷���
	 ...
	 */
	//��ȡһ��Spring Source�ļ��������ڶ���Spring Bean������Դ�ļ�
	protected ResourcePatternResolver getResourcePatternResolver() {
		//AbstractApplicationContext�̳�DefaultResourceLoader�����Ҳ��һ����Դ������
        //Spring��Դ����������getResource(String location)��������������Դ
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			//������������refreshBeanFactory()������Bean������Դ�ļ�������������refreshBeanFactory()��������  
			...
			try {
				...
				//��������ע���BeanFactoryPostProcessor��Bean
				invokeBeanFactoryPostProcessors(beanFactory);

				// Register bean processors that intercept bean creation.
				//ΪBeanFactoryע��BeanPost�¼�������.  
		        //BeanPostProcessor��Bean���ô����������ڼ��������������¼� 
	...
	protected ConfigurableListableBeanFactory obtainFreshBeanFactory() {
		//����ʹ����ί�����ģʽ�����ඨ���˳����refreshBeanFactory()����������ʵ�ֵ�������������refreshBeanFactory()����
		refreshBeanFactory();
	...
	protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
		...
		//����Spring3�Ժ��¼ӵĴ��룬Ϊ����ָ��һ��ת������(ConversionService)  
	    //�ڶ�ĳЩBean���Խ���ת��ʱʹ��  
		...
		//��������������ע���BeanDefinitionԪ���ݣ��Է����޸�
		beanFactory.freezeConfiguration();

		// Instantiate all remaining (non-lazy-init) singletons.
		//��������lazy-init���Եĵ�̬ģʽBean����Ԥʵ��������
