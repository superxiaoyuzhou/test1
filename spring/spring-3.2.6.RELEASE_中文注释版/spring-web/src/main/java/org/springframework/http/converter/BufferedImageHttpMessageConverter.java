 ...
 * {@linkplain ImageIO#getWriterMIMETypes() registered image writer}. This behavior can be overriden by
 * setting the #setContentType(org.springframework.http.MediaType) contentType} properties.
 *
 * <p>If the {@link #setCacheDir(File) cacheDir} property is set to an existing directory, this converter will
 * cache image data.
 *
