...
public class UserService implements UserDetailsService {
    ...
    public void initData() {
        ...
        // 模拟几个用户，替代数据库获取逻辑
        userList.add(new User("piter", password, AuthorityUtils.commaSeparatedStringToAuthorityList("admin")));
...
//        return new User(username, this.passwordEncoder.encode("123456"), true,
//                true, true,
